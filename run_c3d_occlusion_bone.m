function [X, Y, A, Gamma, C, Sigma, u0, V0, W, bone, bone_var] = run_c3d_occlusion_bone(c3dcsv, missing_bone, missing_frame_start, missing_frame_end)
...
[model, Y, LL] = learn_lds_dynammop_bone(X, 'Hidden', H, 'Observed', W, 'Bone', bone, 'MaxIter', maxIter);
