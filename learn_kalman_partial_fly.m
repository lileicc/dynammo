function [Y, A, Gamma, C, Sigma, u0, V0, LL, RMSE, Frob] = learn_kalman_partial_fly(X, A, C, observed, H, maxIter, diagG, diagS, initFunc)
%learning kalman filter parameters for the missing value
% the difference here is :
% when doing forward estimation, it estimates the missing values on the fly
% instead of estimating the missing values after learning new parameters.
%X is N * M dimension
