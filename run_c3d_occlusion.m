function [X, Y, model, W, bone, bone_var] = run_c3d_occlusion(c3dcsv, missing_bone, missing_frame_start, missing_frame_end, varargin)
...
Y_large = Y * 1000;
save(sprintf('%s_%s_%d-%d_fly.mat', c3dcsv, num2str(missing_bone), missing_frame_start, missing_frame_end));
csvwrite(sprintf('%s_%s_%d-%d_fly.csv', c3dcsv, num2str(missing_bone), missing_frame_start, missing_frame_end), Y_large);

%% play the recovered motion animation
play_mocap_skel(Y, lab.colheaders, sprintf('%s_%s_%d-%d_fly.avi', c3dcsv, num2str(missing_bone), missing_frame_start, missing_frame_end));
...
saveas(gcf, sprintf('%s_%s_%d-%d_fly.eps', c3dcsv, num2str(missing_bone), missing_frame_start, missing_frame_end), 'psc2');
